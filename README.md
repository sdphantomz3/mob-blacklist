...
| `/mob_blacklist clear_world`                                 | Sweeps all loaded chunks across all dimensions (Overworld, Nether, End) and kills every blacklisted mob currently alive. |
| `/mob_blacklist clear_world <mob_id>`                        | Instantly purges all loaded instances of one specific blacklisted mob type from the world.                               |
